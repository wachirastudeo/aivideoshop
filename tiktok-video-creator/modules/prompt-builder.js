...
const PRESENTERS = {
  ...
  dog: "A friendly Thai reviewer standing in full-body view together with a cute dog (e.g., golden retriever or corgi), presenting the product and playing or interacting with the dog in a bright, clean indoor setting.",
  cat: "A friendly Thai reviewer standing in full-body view together with a cute fluffy cat, presenting the product and playing or interacting with the cat in a cozy, warm indoor setting."
};
...
const HANDS_DIRECTION = "NATURAL HAND & BODY POV ANATOMY LOCK: Realistic first-person POV (Point of View) perspective looking directly at the product in real use. Show realistic anatomically correct human hands and forearms holding or presenting it gently with a natural ergonomic grip. STRICT MAXIMUM TWO-HAND COUNT LOCK: The frame must contain AT MOST 2 human hands in total (strictly 1 left hand and 1 right hand, or 1 single hand). ABSOLUTELY FORBIDDEN: rendering 3 hands, floating extra hands, a third hand, duplicated hands, or extra fingers. Each hand must have strictly exactly 5 fingers with natural fingernails, clean skin texture, realistic knuckles, and wrist joints; no extra fingers, no mutated digits, no clipping into the product.";
