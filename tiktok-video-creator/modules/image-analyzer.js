...
function normalizeAutoOptions(value, productInfo = {}) {
  ...
  return {
    videoStyle: pickAllowed(raw.videoStyle, ["sales", "review", "lifestyle", "flash-sale", "unboxing", "before-after", "testimonial", "cinematic", "still-motion", "trending-hook"], inferred.videoStyle),
    presenter,
